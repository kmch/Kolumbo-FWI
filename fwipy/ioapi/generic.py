...
from fwipy.generic.decor import timer
from fwipy.generic.parse import exten, strip, kw, del_kw
from fwipy.generic.system import exists, bash

from fwipy.plot.generic import FilePlotter
...
class FilePreparer(object):
  ...
  def dupl(self, source, cmd='cp', **kwargs):
    ...
    """
    from fwipy.generic.parse import exten
    from fwipy.generic.system import duplicate
...
class TextFile(File):
  ...
  not directlfwipy.plottable as an array.
...
def read_any_format(fname, **kwargs):
  ...
  """
  from fwipy.ioapi.fw3d import read_vtr, read_ttr
  from fwipy.ioapi.segy import read_sgy
  from fwipy.ioapi.memmap import read_mmp
