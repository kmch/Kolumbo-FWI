...
from fwipy.generic.parse import kw, strip, exten, \
  path_leave, path_extract
from fwipy.ioapi.generic import ArrayFile, CsvFile
...
class SgyFile(ArrayFile):
  ...
  def filt(self, pad, overwrite=False, **kwargs):
    ...
    from fwipy.dsp.su import su_filter_full
  ...
  def mute(self, fbreaks, ntaper=100, twin=1, **kwargs):
    """
    """
    from fwipy.dsp.su import su_mute # not used actually!
    from fwipy.ioapi.generic import save_txt
  ...
  def split(self, key, **kwargs):
    ...
    from fwipy.generic.parse import extend_fname
...
def read_sgy(fname, overwrite=True, **kwargs):
  ...
  **kwargs : keyword arguments (optional)
  ...
  """
  from fwipy.generic.system import exists
...
def header2json(fname, **kwargs):
  ...
  """
  from fwipy.generic.parse import strip
