...
import fwipy # only for prot_path
from fwipy.seismic.data import DataFileSgy, DataIO, DataIOFactory
from fwipy.seismic.exp import Experiment
from fwipy.seismic.misc import Box3d
from fwipy.seismic.models import Mod
from fwipy.seismic.plots import PlotExp
from fwipy.seismic.surfs import SeaLand
from fwipy.seismic.wavelets import SourceWavelet

from nsh.generic import ShellFactory
path_prot = '%s/proteus/' % os.path.dirname(fwipy.seismic.__file__)
