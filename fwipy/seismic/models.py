...
# to get rid of
# -------------------------------------------------------------------------------
from fwipy.generic.decor import timer #FIXME
from fwipy.generic.parse import kw, del_kw #FIXME
from fwipy.ndat.arrays import A3d #FIXME
...
def gauss(dims, centers, radius, **kwargs):
  ...
  """
  from fwipy.numeric.funcs import gauss as gaussian
  coords = np.indices(dims)
  A = np.zeros(dims)
