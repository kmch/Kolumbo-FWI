...
from fwipy.ioapi.generic import save_txt  # for mute
...
from fwipy.generic.parse import kwarg_over_attr, path_leave # FIXME
from fwipy.generic.system import get_files # FIXME
from fwipy.ndat.arrays import Arr3d # FIXME
from fwipy.ioapi.generic import ArrayFile # FIXME
from fwipy.plot.generic import * # FIXME
# ----------------------------------------------------------------------------
class Dat:
  def __init__(self, dt, arr=None, file=None):
    ...
    file : file object, e.g. fwipy.ioapi.segy.SgyFile
    """
...
class DataIOFactory:
  ...
  def create(cls, ID, *args, **kwargs):
    import fwipy.seismic.proteus
    import fwipy.seismic.rainbow
