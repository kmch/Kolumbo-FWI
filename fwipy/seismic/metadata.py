...
from fwipy.generic.parse import kw, del_kw, path_leave
from fwipy.generic.system import bash, get_files

from fwipy.ioapi.generic import *
from fwipy.ioapi.segy import *

from fwipy.seismic.data import DataFileSgy
from fwipy.seismic.models import *
from fwipy.seismic.surfs import *
...
class Box3d:
  ...
  def plot(self, **kwargs):
    from fwipy.plot.misc import plot_square, plot_box
