...
from fwipy.ndat.arrays import Arr3d # a-b
from fwipy.plot.generic import * 
from fwipy.project.generic.au import ProjBox
from fwipy.project.generic.au import ProjGeometry
from fwipy.project.types.basic import ProjSyn, ProjInv
...
class Box(ProjBox):
    ...
    def plot(self, figsize=None, label=None, aspect='equal'):
        from fwipy.plot.misc import plot_box
...
def plot_data_and_geom(datafile, md, sid, ep, **kwargs):
    from fwipy.plot.plt2d import colorbar
...
def add_spherical_anomaly(m, center=(100,235,50), radius=20, anom=-0.4, smooth=True):
    ...
    """
    from fwipy.seismic.models import sphere
...
def tintegrate_wvlt(rsg, plot=False):
    ...
    from fwipy.ndat.arrays import Arr1d
