"""
Interactive events based on mouse actions.
...
class IndexTracker(object):
  ...
  def __init__(self, ax, A, istep=1, **kwargs):
    """
    """
    from fwipy.ndat.arrays import slice_array
    from fwipy.plot.generic import plot_array
...
class IndexTrackerAll(object):
  ...
  def __init__(self, fig, A, istep=1, **kwargs):
    ...
    vmin = kwargs.get('vmin', 1500)
    vmax = kwargs.get('vmax', 6500)
    self.imshow_kwargs = {'cmap': cmap,'vmin': vmin, 'vmax': vmax}    
