...
def strip(fname, **kwargs):
  ...
  >>> strip('aa.bb.cc')
  WARNING: fwipy.generic.parse.exten: aa.bb.cc contains > 1 full stop. Taking last bit as an extension.
  'aa.bb'  
...
def kw(kwarg_name, default_value, kwargs):
  ...
  >>> kwargs = {}
  >>> kw('my_key', 1, kwargs, warning=1)  
  fwipy.generic.parse WARNING Value of my_key not specified. Setting default value 1
