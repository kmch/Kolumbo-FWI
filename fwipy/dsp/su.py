...
from fwipy.generic.system import bash, exists
from fwipy.generic.parse import kw, strip
...
def su_process(A, func, dt, *args, **kwargs):
  ...
  from fwipy.ioapi.segy import array2sgy
  
  #su_process._log.warning('shh %s' % A.shape)
  #su_process._log.warning('fffunc %s' % func)
  #su_process._log.warning('dddt %s' % dt)
  #su_process._log.warning('ars %s' % args)
  #su_process._log.warning('kars %s' % kwargs)
...
def su_decon(fname, d_inp, d_out, pnoise, **kwargs):
  ...
  """
  from fwipy.ioapi.su import array2su
  from fwipy.ndat.arrays import list2str
  from fwipy.ioapi.generic import read_txt
...
def su_taper(fname, taper_front, taper_back, **kwargs):
  ...
  """
  from fwipy.ioapi.su import get_ntraces, sugethw
...
def su_pad(fname, pad, trim=False, **kwargs):
  ...
  """
  from fwipy.ioapi.su import sugethw
...
def su_filter_full(fname, pad, **kwargs):
  ...
  """
  from fwipy.generic.parse import del_kw
