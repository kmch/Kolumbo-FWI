...
from fwipy.generic.decor import widgets, timer
from fwipy.plot.generic import figure, aspeqt, Plotter
from fwipy.plot.plt2d import plot_image
...
class Arr(np.ndarray):
  ...
  def _read(source, **kwargs):
    """
    """
    #from fwipy.seismic.data import Data
    #from fwipy.ndat.manifs import Surf, SurfZ, Plane
    #from fwipy.ndat.points import Points
    #
    ...
    if isinstance(source, str):
      from fwipy.ioapi.generic import read_any
  ...
  def save(self, fname, **kwargs):
    from fwipy.ioapi.fw3d import save_vtr
    save_vtr(self, fname)
  # -----------------------------------------------------------------------------
...
class Arr1d(Arr):
  ...
  def plot(self, **kwargs):
    ...
    """
    from fwipy.plot.plt1d import plot_line
    c = kw('c', None, kwargs)
...
class Arr3d(Plotter, Arr):
  ...
  def scroll(self, **kwargs):
    ...
    """
    import matplotlib.pyplot as plt
    from fwipy.plot.events import IndexTracker
  ...
  def scrollall(self, fig, **kwargs):
    ...
    """
    from fwipy.plot.events import IndexTrackerAll
...
def _set_array_modifiers(**kwargs):
  ...
  from fwipy.numeric.generic import norm_bulk_max
...
def _set_tracewise_modifiers(**kwargs):
  ...
  **kwargs : keyword arguments (optional)
  ...
  """
  from fwipy.numeric.generic import normalize
  from fwipy.numeric.operators import derivative
  from fwipy.numeric.fourier import dft
