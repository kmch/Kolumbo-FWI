...
from fwipy.generic.decor import widgets
from fwipy.generic.system import bash, current_dir
from fwipy.generic.parse import kw

from fwipy.ioapi.clusters.cx1 import *
from fwipy.ioapi.clusters.archer import *
from fwipy.ioapi.clusters.thomas import *
...
class FileManager(object):
  ...
  def rm(self, **kwargs):
    ...
    """
    from fwipy.generic.system import get_files
    from fwipy.generic.parse import path_leave
...
class ProjThroughput(FileManager):
  ...
  def dupl(self, project=None, input_path=None, project_name=None, **kwargs):
    ...
    """
    from fwipy.generic.system import get_files, duplicate
    from fwipy.generic.parse import path_leave, exten
  ...
  def _configure_remote(self, host_nick, **kwargs):
    if host_nick == 'cx1':
      from fwipy.ioapi.clusters.cx1 import proj_path_cx1
      host = "kmc3817@login.cx1.hpc.ic.ac.uk"
      remote_path = host + ':' + proj_path_cx1
    elif host_nick == 'eph':
      from fwipy.ioapi.clusters.cx1 import proj_path_eph
      host = "kmc3817@login.cx1.hpc.ic.ac.uk"
...
class ProjInput(ProjThroughput):
  ...
  def init(self, **kwargs):
    ...
    """
    from fwipy.project.files.datalike.sgy import RawSignFile, SignatureFileSgy
    from fwipy.project.files.datalike.ttr import SignatureFileTtr
    from fwipy.project.files.gridded.misc import InextFile
    from fwipy.project.files.gridded.surfaces import TopoFile, FsFile, ExtendedFsFile, InterpolFsFile
    from fwipy.project.files.other.ghost import GhostDataFileBin, GhostDataFileTxt, \
      SourcesDataFileTxt, ReceiversDataFileTxt
    from fwipy.project.files.text.srcrec import SourcesFile, ReceiversFile
    from fwipy.project.files.text.misc import RawSeisTxtFile, JobInfoFile
    from fwipy.project.files.text.runfiles import SegyPrepFile, Runfile, Skeleton
    from fwipy.project.files.text.submit import BashFile
    from fwipy.project.lists.basic import JobFileList 
  ...
  def check_stability(self, **kwargs):
    from fwipy.fd.checks import check_stability
  ...
  def check_accuracy(self, **kwargs):
    from fwipy.fd.checks import check_accuracy
    from fwipy.dsp.wavelet import find_passband
  ...
  def check_propag_dists(self, **kwargs): 
    from fwipy.fd.checks import check_propag_dists
    from fwipy.dsp.wavelet import find_passband
...
class ProjOutput(ProjThroughput):
  ...
  def init(self, **kwargs):
    ...
    """    
    from fwipy.project.generic.qc import JobStats
    from fwipy.project.files.text.logs import (OutLogFile, ErrLogFile, 
