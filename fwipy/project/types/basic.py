...
from fwipy.generic.decor import timer, widgets
from fwipy.generic.parse import kw, del_kw
from fwipy.generic.system import bash, exists, current_dir
from fwipy.plot.generic import figure

# FIXME: tmp
from fwipy.project.generic.io import _InpPreparer 
...
class Proj(_ProjMeta, _ProjSyncer, _ProjLister, _FwiRunner):
  ...
  def __init__(self, name, **kwargs):
    ...
    """
    from fwipy.project.generic.io import ProjInput, ProjOutput
    from fwipy.project.generic.au import (ProjPath, ProjDirs, ProjDef, ProjGeometry, 
                                               ProjEnv, ProjSgyMapp, ProjBox, ProjCluster,
                                               ProjBaseFiles)
    from fwipy.project.files.text.misc import InfoFile, MetaDataProjFile
    from fwipy.project.files.text.runfiles import Runfile
...
class ProjSyn(_InpPreparer, Proj):
  ...
  def init_input(self, **kwargs):
    ...
    """
    from fwipy.project.files.gridded.models import ModelFileSgy, ModelFileVtr
    from fwipy.project.files.datalike.sgy import DataFileSgy, TemplateFileSgy
    from fwipy.project.files.datalike.ttr import TemplateFileTtr
  ...
  def init_output(self, **kwargs): 
    ...
    """
    from fwipy.project.files.datalike.sgy import SynDataFileSgy
    from fwipy.project.files.datalike.ttr import SynDataFileTtr
    from fwipy.project.files.other.index import SynIndexFileSgy, SynIndexFileTtr
    from fwipy.project.lists.extra import ForwardWavefieldFileList
...
class ProjInv(Proj):
  ...
  def init_input(self, **kwargs):
    ...
    """
    from fwipy.project.files.gridded.models import ModelFileVtr, ModelFileSgy
    from fwipy.project.files.datalike.ttr import ObsDataFileTtr
    from fwipy.project.files.datalike.sgy import ObsDataFileSgy
    from fwipy.project.files.other.index import ObsIndexFileSgy, ObsIndexFileTtr
    from fwipy.project.files.text.hed import ObsHedFile
  ...
  def init_output(self, **kwargs):
    ...
    """
    from fwipy.project.files.gridded.models import ModelFileVtr, ModelFileSgy
    from fwipy.project.files.gridded.derivs import GradFile, PrecFile
    from fwipy.project.files.datalike.ttr import DumpDataFile, DumpCompareFile
    from fwipy.project.lists.extra import CPFileList, DumpFileList, \
      ForwardWavefieldFileList, BackpropWavefieldFileList
    from fwipy.project.files.text.misc import LastCheckpointFile
    from fwipy.project.generic.qc import Functional
