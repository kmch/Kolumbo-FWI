...
from fwipy.config.logging import log_lvl
...
class GenericSetUp(object):
  ...
  def _set_path(self):  
    self.path = "/home/kmc3817/projects_datadrive1/code_fwipy_tests/"

  # -----------------------------------------------------------------------------

  def _set_experiment(self):
    from fwipy.ioapi.proteus import ProteusExperiment
  ...
  def _set_base(self):
    self.base = dict(tvp=self.exp.svp['bh']['18-04-24'],\
                ...
                rse=['/home/kmc3817/projects_datadrive1/code_fwipy_tests/data/tmp-Synthetic.sgy'],\
                sp=None)    
